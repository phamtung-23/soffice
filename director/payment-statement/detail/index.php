          ...
          <div class="row mb-3 row-payment mt-3 ps-4 d-flex align-items-center">
            ...
            <div class="col-sm-2 pb-2">
              <input type="text" class="form-control 
                ...
                ?>" name="customField[]" placeholder="Ex: 1.000.000" required value="<?= number_format($customField['value'], 0, ",", ".") ?>" oninput="updateAmountText(this)"
                <?php
                if (isset(($customField['value_old']))) {
        ...
        <table class="table table-bordered mb-4">
          ...
          <tbody class="tableBody">
            ...
            ?>
              <tr>
                ...
                ?>" required name="expense_amount[]" id="expenses_amount" value="<?= number_format($expense['expense_amount'], 0, ',', '.') ?>"
                    <?php
                    if (isset(($expense['expense_amount_old']))) {
                ...
                ?>
                <td class="text-center align-middle"><input type="checkbox" class="select-expense form-check-input" name="expense_ops[]" onchange="updateOpsTotal()" <?= $expense['expense_ops'] == 'on' ? 'checked' : '' ?>></td>
              </tr>
            <?php
            }
            ?>
          ...
          <tfoot>
            <tr>
              ...
              <td colspan="2">
                OPS TOTAL: <input type="text" class="form-control" name="ops_total" id="ops_total" disabled <?= $expense['expense_ops'] == 'on' ? 'checked' : '' ?>>
              </td>
            </tr>
          </tfoot>
