...
header('Content-Type: application/json');
  ...
  foreach ($jsonData as &$entry) {
    if ($entry['instruction_no'] == $data['instruction_no']) {
      ...
      $entry['trucking'] = (float)str_replace('.', '', $data['trucking']);
      ...
      $entry['stuffing'] = (float)str_replace('.', '', $data['stuffing']);
      ...
      $entry['liftOnOff'] = (float)str_replace('.', '', $data['liftOnOff']);
      ...
      $entry['chiHo'] = (float)str_replace('.', '', $data['chiHo']);
